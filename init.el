...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; Adds folder/file watching in lsp-session on demand -- only when you open a file of a folder does it watch that folder.
